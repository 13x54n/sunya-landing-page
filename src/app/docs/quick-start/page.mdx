...
export const metadata = {
  title: "Quick Start",
  description: "Get started with Sunya in 3 steps: install via curl, create sunya.config.json, run sunya scan. Scan Foundry and Hardhat projects for vulnerabilities.",
  openGraph: {
