...
export const metadata = {
  title: "Quick Start",
  description: "Get started with Sunya in 3 steps: install (curl, PowerShell, or CMD), create sunya.config.json, run sunya scan. Scan Foundry and Hardhat projects for vulnerabilities.",
  openGraph: {
